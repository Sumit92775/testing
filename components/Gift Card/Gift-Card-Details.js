...
const GiftCardDetails = () =>{
    return(
        <div className="card card2 pl-20 pt-12 txt mb-30" style={{border : "1px solid var(--primary-1)", backgroundColor : "#F8F8F8"}}>
            ...
            <div className="grid-view grid-3 colgap-14">
                <div>
                    <strong>Name</strong>
                    <p>Gift Card 1</p>
                </div>
                ...
                <div>
                    ...
                    <p><strong>in 10 days</strong> (14 Nov, 2020)</p>
                </div>
            </div>
            
            <div className="grid-view grid-3 colgap-14"  style={{borderBottom : "0px solid red !important"}}>
