                ...
                if(res.status){
                    ...
                    setTotalBookings(res.bookings);
                        ...
                        for(let i = 0; i < res.bookings.length; i++) {
                            ...
                            // console.log("Add1: ",res.bookings[i].Service.Store.Addresses[i]);
                            // if(res.bookings[i].Service.Store.Addresses[i].add1 === undefined){
                            
                            // }else{
                                // console.log("Add1: ",res.bookings[i].Service.Store.Addresses[0]);
                            // }
