...
//                             <Menu.Item key="Accept" className="txt dark1" icon={<span className="material-icons">done</span>}>Accept</Menu.Item>
//                             <Menu.Item key="Reject" className="txt danger" onClick={ () => toggleVisibility(true) } icon={<span className="material-icons">cancel</span>}>Reject</Menu.Item>
//                         </Menu.SubMenu>
//                     </Menu>
//                 </>
//             }
...
//     return (
//         <div>
//             <h5 className="mb-25">Reschedule Request From SP</h5>
                ...
                if(res.status){
                    ...
                    for(let i = 0 ; i < userRescheduledBookingsArray.length ; i++){
                        ...
                        for(let i = 0; i < yourRescheduleArray.length; i++) {
                            ...
                            setBookingAddress(yourRescheduleArray[i].Booking.Service.Store.Addresses);

                            let address = "";

                            address+=yourRescheduleArray[i].Booking.Service.Store.Addresses[0].add1+", ";
                            address+=yourRescheduleArray[i].Booking.Service.Store.Addresses[0].add2+", "
                            address+=yourRescheduleArray[i].Booking.Service.Store.Addresses[0].city+", "
                            address+=yourRescheduleArray[i].Booking.Service.Store.Addresses[0].zipCode;
                            ...
                            dataSource.push({
                                ...
                                spname: {spname: yourRescheduleArray[i].Booking.Service.Store.storeName, address: address},
                                // address: "Jeddah Nazlah Dist...",
                                olddateandtime: yourRescheduleArray[i].OldTime,
                                newdateandtime: yourRescheduleArray[i].newTime,
                                service: {service: yourRescheduleArray[i].Booking.Service.primaryServiceName, variant: yourRescheduleArray[i].Booking.Service.variationName , type: serviceType},
                                // servicetype: 'In-Store',
